...
COM_LIST = {
    "date_bith": ("когда", "родился", "когда родился",
    ...
    "word": ("сделай в ворде","открой ворд", "в ворде", "ворде"),
    ...
    "open_proggram": ("открой телеграм","открой дискорд",
                      "открой спотифай","открой стим")
}   
